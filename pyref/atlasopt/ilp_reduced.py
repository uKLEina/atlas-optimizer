...
def solve(g: AtlasGraph, terminals, excluded=(), time_limit: float = 60.0) -> SolveResult:
    red = build(g, terminals, excluded)
    ...
    add_vars(
        h,
        costs=[g.cost(v) for v in V] + [float(w) for _, _, w in arcs] + [0.0] * m,
